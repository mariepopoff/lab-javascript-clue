...
function pickMystery(){
 let misteryObject = new Object();
 misteryObject.suspect = selectRandom(suspectsArray);
 misteryObject.weapon = selectRandom(weaponsArray);
 misteryObject.room = selectRandom(roomsArray);
